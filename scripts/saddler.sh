...
cp -v "sample/build/reports/checkstyle/checkstyle.xml" "$LINT_RESULT_DIR/"
cp -v "sample/build/reports/findbugs/findbugs.xml" "$LINT_RESULT_DIR/"
cp -v "sample/build/reports/pmd/pmd.xml" "$LINT_RESULT_DIR/"
cp -v "sample/build/reports/pmd/cpd.xml" "$LINT_RESULT_DIR/"
cp -v "sample/build/outputs/lint-results.xml" "$LINT_RESULT_DIR/"
...
echo "* checkstyle       *"
echo "********************"
cat sample/build/reports/checkstyle/checkstyle.xml \
...
echo "* findbugs         *"
echo "********************"
cat sample/build/reports/findbugs/findbugs.xml \
...
echo "* PMD              *"
echo "********************"
cat sample/build/reports/pmd/pmd.xml \
...
echo "* PMD-CPD          *"
echo "********************"
cat sample/build/reports/pmd/cpd.xml \
...
echo "* android lint     *"
echo "********************"
cat sample/build/outputs/lint-results-debug.xml \
